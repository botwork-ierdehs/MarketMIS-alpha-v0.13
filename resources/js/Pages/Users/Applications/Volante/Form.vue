...
import { formatAmount, formatDateShort, formatFees, fullName, isEditPage, isRenewalPage, isReuploadPage, mapTablesToGeoJSON } from '@/data/helper';
...
const form = useForm({ 
  ...
  : [] : [],
  step,
  bulb: checkIfEdit() || checkIfReupload() ? props?.volanteRental?.bulb : 0,
